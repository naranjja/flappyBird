...
public class Bird : MonoBehaviour {
    ...
    void BuildLevel () {
        ...
        Instantiate(pipe_down, new Vector3(7, randomPipe1Y), transform.rotation);
        Instantiate(pipe_up, new Vector3(7, randomPipe1Y-12), transform.rotation);

        Instantiate(pipe_down, new Vector3(15, randomPipe2Y), transform.rotation);
        Instantiate(pipe_up, new Vector3(15, randomPipe2Y-12), transform.rotation);
    }
